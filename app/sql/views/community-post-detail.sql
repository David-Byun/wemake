...
GROUP BY posts.post_id, topics.topic_id, topics.topic, topics.slug,
 profiles.username, profiles.avatar, profiles.role, profiles.created_at, profiles.profile_id;
