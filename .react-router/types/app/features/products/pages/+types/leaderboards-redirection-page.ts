...
type Module = typeof import("../leaderboards-redirection-page.js")

export type Info = {
  parents: [Parent0, Parent1],
  id: "features/products/pages/leaderboards-redirection-page"
  file: "features/products/pages/leaderboards-redirection-page.tsx"
  path: "/products/leaderboards/:period"
  params: {"period": string} & { [key: string]: string | undefined }
  module: Module
