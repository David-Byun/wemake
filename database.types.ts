  ...
  public: {
    Tables: {
      ...
      followers: {
        ...
        Relationships: [
          {
            foreignKeyName: "followers_follower_id_profiles_profile_id_fk"
            columns: ["follower_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "followers_following_id_profiles_profile_id_fk"
      ...
      post_upvotes: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_post_upvotes_post"
            columns: ["post_id"]
            isOneToOne: false
            referencedRelation: "community_post_detail"
            referencedColumns: ["post_id"]
          ...
          {
            foreignKeyName: "fk_post_upvotes_profile"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["profile_id"]
